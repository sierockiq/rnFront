...
class CommandsFormContainer extends Component {
  constructor() {
    super();
...
CommandsFormContainer.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(CommandsFormContainer);
